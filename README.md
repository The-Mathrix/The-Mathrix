...
<script>
// --- Helpers to make answer checking forgiving (spaces and unicode minus) ---
...
const correctAnswers = {
  ...
  21:{question:"Find x if f(x) = 5x − 7 and f(a) = 18.",answers:["5"]},
  22:{question:"Find x if f(x) = 2x + 9 and f(a) = −5.",answers:["-7"]},
  23:{question:"Find x if f(x) = x/4 + 6 and f(a) = 10.",answers:["16"]},
  24:{question:"Find x if f(x) = 7 − 3x and f(a) = −11.",answers:["6"]},
  25:{question:"Find x if f(x) = 4x² and f(a) = 64.",answers:["4","-4","±4"]},
  26:{question:"Find x if f(x) = x² − 5 and f(a) = 20.",answers:["5","-5","±5"]},
  27:{question:"Find x if f(x) = (2x + 3)/5 and f(a) = 7.",answers:["16"]},
  28:{question:"Find x if f(x) = (x − 4)/2 and f(a) = −6.",answers:["-8"]},
  29:{question:"Find x if f(x) = (x − 2)² and f(a) = 49.",answers:["9","-5"]},
  30:{question:"Find x if f(x) = 3x² + 2 and f(a) = 29.",answers:["3","-3","±3"]},
  31:{question:"Find x if f(x) = (x + 5)/3 − 2 and f(a) = 4.",answers:["13"]},
  32:{question:"Find x if f(x) = 10 − x/2 and f(a) = 1.",answers:["18"]},
  33:{question:"Find x if f(x) = x² − x and f(a) = 12.",answers:["4","-3"]},
  34:{question:"Find x if f(x) = 5(x − 1)² − 3 and f(a) = 17.",answers:["3","-1"]},
  35:{question:"Find x if f(x) = (4x − 1)/(x + 2) and f(a) = 3.",answers:["7"]},

  36:{question:"f(x) = (x + 5)/(x - 2)\nFind the vertical asymptote.",answers:["x=2","2"]},
  37:{question:"f(x) = (3x)/(x^2 - 1)\nFind the horizontal asymptote.",answers:["y=0"]},
  38:{question:"f(x) = (2x - 1)/(x + 3)\nFind the x-intercept.",answers:["(1/2,0)","(0.5,0)","x=1/2","x=0.5"]},
  39:{question:"f(x) = 4/(x^2 - 9)\nFind the y-intercept.",answers:["(0,-4/9)"]},
  40:{question:"f(x) = (x^2 - 4)/(x - 2)\nFind the hole (x-coordinate only).",answers:["2","x=2"]},

  41:{question:"Find the vertical asymptote of f(x) = (x + 3)/(x - 5)",answers:["5","x=5"]},
  42:{question:"f(x) = (5x)/(x^2 + 1)\nHorizontal asymptote?",answers:["y=0"]},
  43:{question:"f(x) = (x^2 + 2x)/(x^2 - 4)\nFind vertical asymptote(s).",answers:["x=2,x=-2","x=±2","x=2orx=-2"]},
  44:{question:"f(x) = (2x^2)/(x^2 - 16)\nFind horizontal asymptote.",answers:["y=2"]},
  45:{question:"f(x) = (x - 6)/(x + 6)\nFind x-intercept.",answers:["(6,0)","x=6"]},
  46:{question:"f(x) = (x^2 - x - 6)/(x^2 + 3x + 2)\nFind the hole (x-coordinate only).",answers:["-2","x=-2"]},
  47:{question:"f(x) = 3/(x-5) + 2\nFind horizontal asymptote.",answers:["y=2"]},
  48:{question:"f(x) = (x^2 - 1)/(x^3 + 1)\nFind y-intercept.",answers:["(0,-1)"]},
  49:{question:"f(x) = (x + 7)/(x^2 - 49)\nFind the vertical asymptote (not the hole).",answers:["7","x=7"]},
  50:{question:"f(x) = (x^2)/(x^2 + 4)\nFind the range.",answers:["[0,1)","0<=y<1","0≤y<1","y∈[0,1)"]}
};
